...
void RobotPhysics::motors_to_angvels(double mPowers[4], double angVels[4]) {
    angVels[0] = mPowers[0] * sim_robot.model.motor_scale_FL / 100.0 * sim_robot.model.max_rpm * 2.0 * PI * sim_robot.model.wheel_rad;
    angVels[1] = mPowers[1] * sim_robot.model.motor_scale_FR / 100.0 * sim_robot.model.max_rpm * 2.0 * PI * sim_robot.model.wheel_rad;
    angVels[2] = mPowers[2] * sim_robot.model.motor_scale_RL / 100.0 * sim_robot.model.max_rpm * 2.0 * PI * sim_robot.model.wheel_rad;
    angVels[3] = mPowers[3] * sim_robot.model.motor_scale_RR / 100.0 * sim_robot.model.max_rpm * 2.0 * PI * sim_robot.model.wheel_rad;
}
